...
import { NgApexchartsModule, ApexAxisChartSeries, ApexChart, ApexXAxis, ApexDataLabels, ApexTooltip, ApexPlotOptions, ApexLegend, ApexGrid, ApexStroke } from 'ng-apexcharts';
import { DespesasService, ResumoProgramaAcao, ItemAcaoResumo, EvolucaoAssistenciaItem } from '../../core/services/despesas.service';
...
export class DestinacaoEstudantilComponent implements OnInit {
  ...
  // --- Dados mensalizados da ação selecionada ---
  ...
  // --- Gráfico comparativo Assistência vs. Funcionamento (AC-013 / AC-018) ---
  ...
  // --- Gráfico de evolução mensal em LINHA (AC-019 / AC-022) ---
  ...
  evolucaoMensalChart: ApexChart = {
    type: 'line', height: 280, toolbar: { show: false }, fontFamily: 'inherit',
    animations: { enabled: true, speed: 600 }
  };
  evolucaoMensalStroke: ApexStroke = { curve: 'smooth', width: 3 };
  evolucaoMensalColors = ['#006633', '#cc0000'];

  // --- Gráfico de curva acumulada em LINHA (AC-020 / AC-022) ---
